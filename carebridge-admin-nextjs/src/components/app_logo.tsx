...
const AppLogo = ({
    ...
    return (
        <Link href="/" className="flex items-center space-x-2 no-underline group">
            <div className="flex items-center space-x-1 transform transition-transform duration-300 group-hover:scale-105">
