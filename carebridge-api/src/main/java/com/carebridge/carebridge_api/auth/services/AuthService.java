...
public class AuthService {
        ...
        public LoginResponse loginService(LoginRequest loginRequest) throws MessagingException, IOException {
                ...
                if (user.getDeviceInfos().stream().noneMatch(
                        ...
                        newDevice.setDeviceType(loginRequest.getDeviceInfo().getDeviceType());
                        newDevice.setOperatingSystem(loginRequest.getDeviceInfo().getOperatingSystem());
                        newDevice.setOsVersion(loginRequest.getDeviceInfo().getOsVersion());
                        newDevice.setBrowser(loginRequest.getDeviceInfo().getBrowser());
                        newDevice.setBrowserVersion(loginRequest.getDeviceInfo().getBrowserVersion());
                        newDevice.setDeviceToken(loginRequest.getDeviceInfo().getDeviceToken());
                        newDevice.setIpAddress(loginRequest.getDeviceInfo().getIpAddress());
        ...
        public void resetPasswordService(ResetPasswordRequest resetPasswordRequest) {
                ...
                Token token = tokenRepository
                                .findTokenByTokenAndEmailAndUsedFor(resetPasswordRequest.getToken(),
                ...
                if (token.getUsedFor() == TokenUsedFor.CHANGE_PASSWORD
                                && resetPasswordRequest.getOldPassword() != null) {
        ...
        public void changeEmailService(ChangeEmailRequest changeEmailRequest) {
                ...
                Token token = tokenRepository
                                .findTokenByTokenAndEmailAndUsedFor(changeEmailRequest.getToken(),
        ...
        public RegisterAccountResponse registerAccountService(RegisterAccountRequest registerAccountRequest) {
                ...
                biodata.setMobilePhone(registerAccountRequest.getMobilePhone());
